...
Following download of data, an initial parameter was set to only keep transcripts whose counts were greater than 0. A count matrix with `r ncol(count_matrix)` samples and `r nrow(count_matrix)` was saved locally.
